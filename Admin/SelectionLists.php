...
class SelectionLists extends Page
{
    ...
    public function seeAddFieldFormEnabled(): static
    {
        ...
        $I->selectEditFrame();
        $I->retrySeeElement($this->addFieldNameInput . ':not([disabled])');
    ...
    public function seeAddFieldFormDisabled(): static
    {
        ...
        $I->selectEditFrame();
        $I->retrySeeElement($this->addFieldNameInput . '[disabled]');
    ...
    public function seeEditFormReadOnly(): static
    {
        ...
        $I->selectEditFrame();
        $I->retrySeeElement($this->selectionListTitleInput . '[disabled]');
    ...
    public function seeFieldActionsEnabled(): static
    {
        ...
        $I->selectEditFrame();
        $I->retrySeeElement($this->saveFieldButton . ':not([disabled])');
    ...
    public function seeFieldActionsDisabled(): static
    {
        ...
        $I->selectEditFrame();
        $I->retrySeeElement($this->saveFieldButton . '[disabled]');
