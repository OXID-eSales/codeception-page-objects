...
trait PaymentSummary
{
    ...
    {
        $I = $this->user;
        $I->seeText($value, sprintf($this->summaryText, Translator::translate('BASKET_TOTAL_WRAPPING_COSTS_NET')));
        return $this;
    }
    ...
    {
        $I = $this->user;
        $I->seeText($value, sprintf($this->summaryText, Translator::translate('SURCHARGE')));
        return $this;
    }
    ...
    {
        $I = $this->user;
        $I->seeText($value, sprintf($this->summaryText, Translator::translate('SHIPPING_NET')));
        return $this;
    }
    ...
    {
        $I = $this->user;
        $I->seeText($value, sprintf($this->summaryText, Translator::translate('TOTAL_NET')));
        return $this;
    }
    ...
    {
        $I = $this->user;
        $I->seeText($value, sprintf($this->summaryText, Translator::translate('PLUS_VAT')));
        return $this;
    }
    ...
    {
        $I = $this->user;
        $I->seeText($value, sprintf($this->summaryText, Translator::translate('GIFT_WRAPPING')));
        return $this;
    }
    ...
    {
        $I = $this->user;
        $I->seeText($value, sprintf($this->summaryText, Translator::translate('PAYMENT_METHOD')));
        return $this;
    }
    ...
    {
        $I = $this->user;
        $I->seeText($value, sprintf($this->summaryText, Translator::translate('GREETING_CARD')));
        return $this;
    }
    ...
    {
        $I = $this->user;
        $I->seeText($value, sprintf($this->summaryText, Translator::translate('SHIPPING_COST')));
        return $this;
    }
    ...
    {
        $I = $this->user;
        $I->seeText($value, sprintf($this->summaryText, Translator::translate('TOTAL_GROSS')));
        return $this;
    }
    ...
    public function seeSummarySurchargePaymentMethod(string $value): static
    {
        ...
        $I->seeText($value, sprintf($this->summaryText, $surchargePaymentMethod));
        return $this;
    }
    ...
    {
        $I = $this->user;
        $I->seeText($value, sprintf($this->summaryText, Translator::translate('GRAND_TOTAL')));
        return $this;
    }
}
